# Generated by Django 5.2.6 on 2025-09-29 04:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_id', models.CharField(blank=True, help_text='Google OAuth sub claim', max_length=100, null=True, unique=True)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('external', 'External')], default='user', max_length=20)),
